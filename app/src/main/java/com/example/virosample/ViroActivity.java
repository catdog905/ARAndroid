...
public class ViroActivity extends Activity {
    ...
    private void createDroidAtPosition(Vector position) {
        ...
        object3D.loadModel(mViroView.getViroContext(), Uri.parse("file:///android_asset/proekt.obj"), Object3D.Type.OBJ, new AsyncObject3DListener() {
            @Override
            public void onObject3DLoaded(final Object3D object, final Object3D.Type type) {
               ...
               material.setRoughness(0.23f);
                ...
                object3D.setScale(new Vector(0.00065,0.00065,0.00065));
            }
